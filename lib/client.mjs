...
export class ClientHandler extends EventEmitter { // TODO: Add @emits
    ...
    #eol = LINE_ENDINGS[this.opts.eol];

    constructor(server, id, socket, notify, tsFormat) {
        super();
     ...
     */
    sendRPC(rpc) {
        this.write(`#rpc=${rpc.masqueradedTag} ${rpc.procName} ${rpc.args}${this.#eol}`);
     ...
     */
    sendRPCResult(rpc) {
        this.write(`#result=${rpc.tag} ${rpc.callResult} ${rpc.result}${this.#eol}`);
    }
